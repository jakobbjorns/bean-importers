...
def main(output_dir):
    ...
    with Xvfb():
        ...
        try:
            ...
            time.sleep(5)
            driver.get(
                f"https://global.americanexpress.com/api/servicing/v1/financials/documents?file_format=excel&limit=100&start_date=2026-01-01&end_date=2099-12-31&status=posted&additional_fields=true&itemized_transactions=true&account_key={os.getenv("amex_account_key")}&client_id=AmexAPI"
            )
            time.sleep(5)
